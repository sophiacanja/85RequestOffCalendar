...
const ForgotPassword = () => {
  ...
  return (
    <div style={{
      backgroundImage: `url(${forgotPasswordBackground})`, backgroundRepeat: "no-repeat",
        ...
        if (validSubmission === false) {
          return (
            <Container className="rounded" id="ForgotPasswordContainer">
              <Container className="justify-content-center align-items-center bg-white rounded pb-4" id="LoginFormContainer" fluid="sm">
                <Row>
          ...
          return (
            <Container className="rounded" id="SuccessMessageContainer">
              <Container className="justify-content-center align-items-center align-items-center bg-white rounded" id="SuccessMessage" fluid="sm">
                <Row>
